...
-- This test intends to test two transaction concurrently
-- modify the same tuple.

-- FIXME: before this PR merge, let's consider if the set command can be removed. 
